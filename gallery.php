                            ...
                            <div class="gallery-isotope col-4">
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="images/gallery/popup/img-1.jpg" class="mfp-image" title="Luxury Room view all">
                                            <img src="images/gallery/page/img-1.jpg" alt="">
                                        </a>
                                ...
                                <div class="item-isotope  ground bathroom suite">
                                    <div class="gallery_item">
                                        <a href="images/gallery/popup/img-1.jpg" class="mfp-image" title="Luxury Room view all">
                                            <img src="images/gallery/page/img-2.jpg" alt="">
                                        </a>
                                        <h6 class="text">Lorem Ipsum is simply dummy text of the printing</h6>
                                    </div>
                                </div>
                                ...
                                <div class="item-isotope ground bathroom">
                                    <div class="gallery_item">
                                        <a href="images/gallery/popup/img-1.jpg" class="mfp-iframe">
                                            <img src="images/gallery/page/img-1.jpg" alt="">
                                        </a>
                                        <h6 class="text">Lorem Ipsum is simply dummy text of the printing</h6>
                                    </div>
                                ...
                                <div class="item-isotope  ground bathroom suite ">
                                    <div class="gallery_item">
                                        <a href="images/gallery/popup/img-1.jpg" target="_blank" class="mfp-image">
                                            <img src="images/gallery/page/img-2.jpg" alt="">
                                        </a>
                                        <h6 class="text">Lorem Ipsum is simply dummy text of the printing</h6>
                                    </div>
