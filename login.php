            ...
            <div class="container">
                <div class="login-register">
                    <div class="text text-center">
                        <h2>LOGIN ACCOUNT</h2>
                        <form action="scripts/loginScript.php" method="POST" class="account_form">
                            <div class="field-form">
                                <input id="username" type="text" class="field-text" name="username" title="Enter username" placeholder="User name">
                            </div>
                            <div class="field-form">
                                <input id="password" type="password" class="field-text" name="password" title="Enter Password" placeholder="Password">
                                <span class="view-pass"><i class="lotus-icon-view"></i></span>
                            </div>
                            <div class="field-form field-submit">
                                <button type="submit" name="login" id="login" class="awe-btn awe-btn-13" value="login">Login</button>
                            </div>
