...
{
    echo "<script>alert('User Already Logged In !');location.href = 'index-2.php'</script>";
}
?>
            ...
            <div class="header_content" id="header_content">
                ...
                <div class="container">
                    ...
                    <div class="header_logo">
                        <a href="#"><img src="images/register.jpg" alt=""></a>
                    </div>
                    <!-- END / HEADER LOGO -->
                        ...
                        <ul class="menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="room-3.php">Room 3</a></li>
            ...
            <div class="container">
                <div class="login-register">
                    <div class="text text-center">
                        ...
                        <form name="RegForm" action="scripts/registerScript.php" method="POST" class="account_form">
                            <div class="field-form">
<!--                                <label for="firstname" class="sr-only">First Name</label>-->
                                <input id="name" class="field-text" type="text" name="username" title="Enter username" placeholder="User name*"/>
<!--                                <input type="text" class="field-text" placeholder="User name*">-->
                            </div>
                            <div class="field-form">
                                <input id="email" class="field-text" type="text" name="email" title="Enter email" placeholder="Email*"/>
<!--                                <input type="text" class="field-text" placeholder="Email*">-->
                            </div>
                            <div class="field-form">
                                <input id="password" class="field-text" type="password" name="password" title="Enter password" placeholder="Password*"/>
<!--                                <input type="password" class="field-text" placeholder="Password*">-->
                                <span class="view-pass"><i class="lotus-icon-view"></i></span>
                            </div>
                            <div class="field-form field-submit">
                                <button type="submit" name="register" id="register" class="btn btn-primary" value="register">REGISTER</button>
                            </div>
                        </form>
                    </div>
                </div>
